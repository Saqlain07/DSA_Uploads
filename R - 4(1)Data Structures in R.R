...
# R is a Vectorized Language. That means operations are applied to each element of the vector automatically, without the need to loop through the vector.
...
# List can contain all numerics or characters or a mix of the two or data.frames or recursively other lists.